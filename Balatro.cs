...
[UsedImplicitly]
public class Balatro : SimpleTCPPack<SimpleTCPServerConnector>
{
    ...
    public override Game Game { get; } = new("Balatro", "Balatro", "PC", ConnectorType.SimpleTCPServerConnector);
